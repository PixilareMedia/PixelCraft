...
execute positioned ~ ~1 ~ run scoreboard players operation @e[type=arrow,distance=..1,sort=nearest,limit=1] orm.div.playerID = @s orm.div.playerID
execute positioned ~ ~1 ~ run tag @e[type=arrow,distance=..1,sort=nearest,limit=1] add temporalBolt
