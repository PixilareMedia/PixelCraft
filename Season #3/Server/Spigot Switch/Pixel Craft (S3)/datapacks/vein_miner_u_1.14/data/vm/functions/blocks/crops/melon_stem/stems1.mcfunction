...
execute if score #vm_fortrand vm_calc matches 0..19 run summon item ~ ~ ~ {Item:{id:"minecraft:melon_seeds",Count:1b},Tags:["vm_item"]}
execute if score #vm_fortrand vm_calc matches 20..23 run summon item ~ ~ ~ {Item:{id:"minecraft:melon_seeds",Count:2b},Tags:["vm_item"]}
execute if score #vm_fortrand vm_calc matches 24 run summon item ~ ~ ~ {Item:{id:"minecraft:melon_seeds",Count:3b},Tags:["vm_item"]}
